...
def draw_cube(img, corners, imgpts):
    """
    Draw a cube on the image using its corners and projected points.

    :param img: The input image.
    :param corners: The corners of the cube.
    :param imgpts: The projected points of the cube.
...
def draw(img, corners, imgpts):
    ...
    :param imgpts: The projected points of the object.
